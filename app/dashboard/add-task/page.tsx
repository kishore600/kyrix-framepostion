...
//       console.log("Task data for edit:", task); // Debug log
...
//       // Populate form with task data - handle null/undefined values properly
//       setFormData({
//         title: task.title || "",
//         dueDate: dueDateStr,
//         dueTime: dueTimeStr,
...
//         // Recurrence fields - handle null values with proper defaults
//         recurrenceType: task.recurrenceType || "DAILY",
//         recurrenceInterval: task.recurrenceInterval !== null && task.recurrenceInterval !== undefined 
//           ? task.recurrenceInterval 
//           : 1,
//         recurrenceDayOfWeek: task.recurrenceDayOfWeek !== null && task.recurrenceDayOfWeek !== undefined 
//           ? task.recurrenceDayOfWeek 
//           : new Date().getDay(),
//         recurrenceDayOfMonth: task.recurrenceDayOfMonth !== null && task.recurrenceDayOfMonth !== undefined 
...
//       // Validate recurrence end date is required for recurring tasks
//       if (formData.isRecurring && !formData.recurrenceEndDate) {
//         toast.error("Recurrence end date is required for recurring tasks");
//         setLoading(false);
//         return;
//       }
...
//         taskData.recurrenceInterval = formData.recurrenceInterval;
        
//         // Only include day fields if they're relevant to the recurrence type
//         if (formData.recurrenceType === "WEEKLY") {
//           taskData.recurrenceDayOfWeek = formData.recurrenceDayOfWeek;
//         } else {
//           taskData.recurrenceDayOfWeek = null;
//         }
        
//         if (formData.recurrenceType === "MONTHLY") {
//           taskData.recurrenceDayOfMonth = formData.recurrenceDayOfMonth;
//         } else {
//           taskData.recurrenceDayOfMonth = null;
//         }
        
//         // Recurrence end date is required
//         if (formData.recurrenceEndDate && formData.recurrenceEndDate.trim() !== "") {
//           taskData.recurrenceEndDate = new Date(formData.recurrenceEndDate).toISOString();
//         }
        
//         if (formData.recurrenceCount && formData.recurrenceCount > 0) {
//           taskData.recurrenceCount = formData.recurrenceCount;
//         }
//       }
...
//                           (t) => t.value === formData.recurrenceType,
//                         )?.description
//                       }
//                     </p>
//                   </div>
